...
| Figure 4 | [Script A (RDF map)](../rdfs_and_structure-factors/code_plot_rdf_ru-ru_opt_with_inset_2d-map.py), [Script B (avg RDF map)](../rdfs_and_structure-factors/code_plot_rdf_ru-ru_opt_with_inset_2d-map.py), [Script C (S(q) insta)](../rdfs_and_structure-factors/code_sq_plot.py), [Script D (S(q) avg)](../rdfs_and_structure-factors/code_sq_plot_avg.py) | [Data (Zenodo)](https://doi.org/TBA) | [README](./figure_4_readme.txt) |
