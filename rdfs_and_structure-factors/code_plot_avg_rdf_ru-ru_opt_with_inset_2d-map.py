...
def main():
    ...
    temperature_patterns = {
        '10 K': '../../10K/lammps_out/avg_rdf_analysis/partial_rdfs.txt',
        ...
        '360 K': '../../360K/lammps_out/avg_rdf_analysis/partial_rdfs.txt',
        '370 K': '../../370K/lammps_out/avg_rdf_analysis/partial_rdfs.txt',
        '380 K': '../../380K/lammps_out/avg_rdf_analysis/partial_rdfs.txt',
        '390 K': '../../390K/lammps_out/avg_rdf_analysis/partial_rdfs.txt',                
